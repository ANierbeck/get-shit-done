...
type: gsd
source: /Users/anierbeck/git/get-shit-done/get-shit-done/get-shit-done/templates/debug-subagent-prompt.md
transformed: 2026-02-26T15:55:01.841Z
---
...
```python
<<task>>prompt=template, subagent_type="gsd-debugger", description="Debug UAT-001"<</task>>
```
