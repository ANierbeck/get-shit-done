...
📖 **Usage Guidelines**:
- When you need to add phase with full context and validation
- For integrating add-phase into automated workflows
- When manual intervention is required for complex scenarios

**Do NOT use when**:
- For simple add-phase operations (use basic commands instead)
...
1. **Follow the add-phase workflow** from `@~/.vibe/get-shit-done/workflows/add-phase.md`.
3. The workflow handles all logic including:
4. 1. Argument parsing and validation
5. 2. Roadmap existence checking
6. 3. Current milestone identification
7. 4. Next phase number calculation (ignoring decimals)
8. 5. Slug generation from description
9. 6. Phase directory creation
10. 7. Roadmap entry insertion
11. 8. STATE.md updates

## Output

- Creates/modifies files in ~/.vibe/get-shit-done/workflows/add-phase/
...
- [ ] add-phase parameters validated successfully
...
```bash
vibe execute ~/.vibe/get-shit-done/workflows/add-phase.md
```
