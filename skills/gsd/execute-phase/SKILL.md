...
📖 **Usage Guidelines**:
- When you need to execute phase with full context and validation
- For integrating execute-phase into automated workflows
- When manual intervention is required for complex scenarios

**Do NOT use when**:
- For simple execute-phase operations (use basic commands instead)
...
1. Execute the execute-phase workflow from @~/.vibe/get-shit-done/workflows/execute-phase.md end-to-end.
2. Preserve all workflow gates (wave execution, checkpoint handling, verification, state updates, routing).

## Output

- Creates/modifies files in ~/.vibe/get-shit-done/workflows/execute-phase/
...
- [ ] execute-phase parameters validated successfully
...
```bash
vibe execute ~/.vibe/get-shit-done/workflows/execute-phase.md
```
