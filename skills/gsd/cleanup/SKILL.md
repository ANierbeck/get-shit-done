...
**Do NOT use when**:
- For simple cleanup operations (use basic commands instead)
...
1. Follow the cleanup workflow at @~/.vibe/get-shit-done/workflows/cleanup.md.
2. Identify completed milestones, show a dry-run summary, and archive on confirmation.

## Output

- Creates/modifies files in ~/.vibe/get-shit-done/workflows/cleanup/
...
- [ ] cleanup parameters validated successfully
...
```bash
vibe execute ~/.vibe/get-shit-done/workflows/cleanup.md
```
