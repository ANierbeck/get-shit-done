...
📖 **Usage Guidelines**:
- When you need to plan phase with full context and validation
- For integrating plan-phase into automated workflows
- When manual intervention is required for complex scenarios

**Do NOT use when**:
- For simple plan-phase operations (use basic commands instead)
...
1. Execute the plan-phase workflow from @~/.vibe/get-shit-done/workflows/plan-phase.md end-to-end.
2. Preserve all workflow gates (validation, research, planning, verification loop, routing).

## Output

- Creates/modifies files in ~/.vibe/get-shit-done/workflows/plan-phase/
...
- [ ] plan-phase parameters validated successfully
...
```bash
vibe execute ~/.vibe/get-shit-done/workflows/plan-phase.md
```
