#!/usr/bin/env node
/**
 * Applies ALL necessary fixes to ~/.vibe/skills/
 * 
 * 1. Set compatibility to "Mistral Vibe"
 * 2. Replace slash commands with vibe -p
 * 3. Process blocks with correct instructions
 * 4. Fix broken command formats
 */
...
// Process descriptions for each skill
...
function fixSkill(skillPath) {
  ...
  // 2. Fix slash commands (/gsd:xxx -> vibe -p "gsd-xxx")
  ...
  // 3. Fix broken commands ("gsd-new"-project -> "gsd-new-project")
  ...
  // 4. Replace/create process block
