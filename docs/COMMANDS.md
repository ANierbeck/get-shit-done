...
Mistral Vibe supports flexible GSD skill invocation.

### Invocation Methods

**Option 1: Natural Language (Recommended)**
```
"gsd-help show me the commands"
```
Vibe will auto-detect and execute the `gsd-help` skill.
...
### ⚠️ Important: File Access Permission

**On first use**, Vibe will prompt:
```
Allow access to ~/.vibe/skills/gsd-help/SKILL.md?
[Yes] [No]
```

You **must** select **Yes** for GSD skills to work. This permission is required
for Vibe to read the skill files from your local Vibe skills directory.
